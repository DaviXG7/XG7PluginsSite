    ...
    <>
      <nav className='navbar navbar-expand-md navbar-light bg-light border-bottom border-dark rounded-bottom fixed-top'>
        ...
        <div className="container-fluid">
          <a className="navbar-brand" href=""><img src={Logo.src} alt="logo" width={"70px"} /></a>
          ...
          <div className="collapse navbar-collapse" id="mynavbar">
            <form className="d-flex bg-light rounded">
              <a href="" className='btn'><img src={IconPesquisa.src} alt="" width={"20px"} /></a>
              <input className="form-control me-2" type="text" placeholder="Procurar plugin" />
            </form>
...
export function MainFooter() {
  ...
  return <>
    ...
    <footer className='navbar navbar-expand-md' style={{backgroundColor: 'rgb(240,240,240)', bottom: "0"}}>
