...
<div id="barra-lateral" class="barra-lateral sidebar">
    ...
    <div class="menus">
        ...
        <div class="botoes">
            ...
            <a class="d-flex link-offset-2 link-dark link-underline link-underline-opacity-0" href="admin/plugins.jsp"><i style="color: rgba(255,255,255,.5);" class="bi bi-plug"></i> <p class="textos-botoes" > Plugins</p></a>
        </div>
    </div>
