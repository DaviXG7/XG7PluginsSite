...
<main>
    ...
    <div class="tabela">
        ...
        <tbody>
        <tr>
            <th scope="row">12345567</th>
            <td></td>
            <td>Fulano</td>
            <td>@gmail.com</td>
            <td>123456</td>
            <td>
                <button a href="" class="btn btn-primary">Editar</button>
                <button a href="" class="btn btn-primary">Excluir</button>
            </td>

        </tr>
        <tr>
            <th scope="row">21234556</th>
            <td></td>
            <td>Irineu</td>
            <td>@gmail.com</td>
            <td>123456</td>
